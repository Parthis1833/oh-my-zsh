...
export ANDROID_HOME="/home/parthis/Android/Sdk/"
export PATH="$PATH:$ANDROID_HOME/cmdline-tools/latest/bin"
export PATH="$PATH:$ANDROID_HOME/platform-tools"

export JAVA_HOME="/home/parthis/.sdkman/candidates/java/current"

export PATH="$PATH:/usr/lib/dart/bin"


export M2_HOME="$PATH:/opt/apache-maven-3.6.1"
